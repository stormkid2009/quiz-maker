// adding server component for the composition question at app router
import React from 'react';
import { ApiResponse } from 'src/types/common';
import { CompositionQuestion } from 'src/types/questions';
import { logError } from 'src/utils/logger';
import CompositionClient from 'src/app/exam/client/compositionClientComponent';

// Define the type for the question data.
export interface QuestionData extends CompositionQuestion {
  _id?: string;
}
...
//create timestamp for the key
  ...
  // pass the data with key to force remounting
  return <CompositionClient key={timestamp} questionData ={questionData} />;
}
